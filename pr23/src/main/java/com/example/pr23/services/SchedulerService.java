...
import com.example.pr23.dao.AuthorDAO;
import com.example.pr23.dao.BookDAO;
...
@Service
@ManagedResource(objectName = "pr23MBeans:category=MBeans,name=SchedulerService")
public class SchedulerService {
    @Value("C:\\Users\\simba\\Desktop\\java-3-semester-master\\pr23\\dataFolder")
